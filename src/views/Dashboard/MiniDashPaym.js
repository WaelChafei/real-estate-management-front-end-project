...
export default function DashboardPaym() {
...
useEffect(() => {
  ...
  .then(res=>{
    ...
    for(var i=0 ; i<res.data.length;i++){
        ...
        var paymd=new Date(res.data[i].paymentDay);
        var monthp= paymd.getMonth()

        if(thisYear==year){
        creat.push(month+1);
        }
        if(paymd>=now ){
          accept.push(monthp+1);
          }
          if(paymd<now ){
            refuse.push(monthp+1);
            }
            console.log('month',month );
            console.log('paymd',paymd );
            console.log('now',now );
     ...
     <GridContainer>
        <GridItem xs={12} sm={12} md={4}>
          <Card chart>
            ...
            <CardBody>
              <h4 className={classes.cardTitle}>Deals per month</h4>
              <p className={classes.cardCategory}>
                <span className={classes.successText}>
                  <ArrowUpward className={classes.upArrowCardCategory} /> {deals}
                </span>{" "}
                total Deals
              </p>
            </CardBody>
        ...
        <GridItem xs={12} sm={12} md={4}>
          <Card chart>
            ...
            <CardBody>
              <h4 className={classes.cardTitle}>Expected Payments</h4>
              <p className={classes.cardCategory}>Payments that are expected per months</p>
            </CardBody>
            <CardFooter chart>
              <div className={classes.stats}>
        ...
        <GridItem xs={12} sm={12} md={4}>
          <Card chart>
            ...
            <CardBody>
              <h4 className={classes.cardTitle}>Late Payments</h4>
              <p className={classes.cardCategory}>Deals that have a late for payment</p>
            </CardBody>
            <CardFooter chart>
              <div className={classes.stats}>
