  ...
  const itemsList = [
    {
      ...
      onClick: () => history.push("/comm") 
    },
   
    {
      text: "Dashboard",
      icon: <DashboardIcon  style={{color:"#5CACE0" }} />,
      onClick: () => history.push("/comm/dash")  
    },
    {
     
      text: "Opportunities",
      icon: <AccessibilityIcon  style={{color:"#5CACE0" }}/>,
      onClick: () => history.push("/comm/check") 
    },
    {
      text: "Add contract",
      icon: <AssignmentTurnedInIcon  style={{color:"#5CACE0" }}/>,
      onClick: () => history.push("/comm/deals") 
    }  
  ];
